# Created by Alip Mohammed at 1/4/2022
# Filename: B20_AMS_CloneApplications.feature

Feature: Indexing, FunctionSearch, BinaryComposition for asm-clone
  ...
  Scenario: Indexing, FunctionSearch, BinaryComposition for asm-clone applications
    ...
    And user click a permanent link of Type 2 application
      ...
      # To force Kam1n0 work properly for any of FUNCTION-SEARCH, BINARY-COMPOSITION, INDEXING, DELETE-TEMPORARY-FILES
        ...
        # make sure to delete files in "Temporary directory!" under DeleteTempFiles Tab
        # Then working order: INDEXING, BINARY-COMPOSITION, FUNCTION-SEARCH.

    # Deleting Temp Files and Indexing for asm-clone/Type2 app
    ...
    # If any alert showed up instead of Indexing Completed message,
      # close the alert and click the Index button again!
