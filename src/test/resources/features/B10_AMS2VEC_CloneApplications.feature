...
Feature: Indexing, FunctionSearch, BinaryComposition for asm2vec-clone
  ...
  Scenario: Indexing, FunctionSearch, BinaryComposition for asm2vec-clone applications
    When : an application is created
    And user click a permanent link of Type 1 application
    ...
    And user click RebuildIndex button
